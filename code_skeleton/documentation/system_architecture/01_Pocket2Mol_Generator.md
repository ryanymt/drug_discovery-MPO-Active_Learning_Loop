...
*   **Chemistry Compliance:** While powerful, it can generate invalid valencies (e.g., Nitrogen with 5 bonds). We rely on **RDKit Sanitization** downstream to filter these out.
